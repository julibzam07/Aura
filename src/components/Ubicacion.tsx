      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-stretch">
          ...
          <div className="col-span-1 lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="h-px w-12 bg-carbón/30 mb-6" data-reveal="fade-up" data-reveal-delay="220" />

            <div className="font-sans font-light text-sm md:text-base text-carbón-light/80 leading-relaxed mb-8 space-y-4" data-reveal="fade-up" data-reveal-duration="600" data-reveal-delay="280">
              <p>
            ...
            <div className="p-6 bg-marfil border border-arena-medium/60 rounded-sm mb-6 flex gap-4 items-start shadow-sm_" data-reveal="fade-up" data-reveal-delay="340">
              ...
              <div>
                ...
                <p className="font-sans text-xs text-carbón-light/75 mt-1.5">
                  A solo 1 hora y 15 minutos de la Ciudad de Panamá.
                </p>
              </div>
            </div>

            {/* Acciones de Ruta: Waze */}
            <div id="route-actions-group" className="flex w-full" data-reveal="fade-up" data-reveal-delay="400">
              <a
                id="btn-waze-route"
                href="https://waze.com/ul/hd1x0wk17g"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-5 py-3 bg-marfil/40 border border-[#73634c]/30 hover:border-[#73634c]/60 hover:bg-marfil rounded-none transition-all duration-300 text-xs font-sans font-semibold uppercase tracking-[0.2em] text-[#73634c] hover:text-carbón w-full h-11 cursor-pointer select-none"
              >
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-4.5 h-4.5 fill-[#73634c] transition-colors duration-300"
                >
                  <title>Waze</title>
          ...
          <div className="col-span-1 lg:col-span-7 flex flex-col justify-center" data-reveal="slide-in-right" data-reveal-duration="1200">
            <div className="relative w-full h-[450px] shadow-xl rounded overflow-hidden bg-marfil border border-arena-medium/60">
              ...
              <iframe
                ...
                src="https://maps.google.com/maps?q=G4XC%2B34%20Nueva%20Gorgona%2C%20Panam%C3%A1&z=16&output=embed&hl=es"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
