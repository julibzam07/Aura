...
import portadaImg from "../assets/images/frame_3.jpg";
    ...
    <section id="recorrido" className="bg-arena-light py-20 md:py-32 px-6 md:px-12 relative overflow-hidden text-carbón border-t border-arena-medium/40">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <div className="w-12 h-px bg-carbón/30 mx-auto mb-6" data-reveal="fade-up" data-reveal-delay="220" />
          
          <p className="font-sans font-light text-sm md:text-base text-carbón-light/80 leading-relaxed max-w-xl mx-auto" data-reveal="fade-up" data-reveal-delay="280" data-reveal-duration="600">
        ...
        <div className="max-w-5xl mx-auto relative group bg-marfil rounded overflow-hidden border border-arena-medium/55" data-reveal="scale-in" data-reveal-duration="1200">
          <div className="relative h-[450px] sm:h-[600px] w-full bg-[#121514]">
            {!showPortada && (
              <iframe
                src="https://itsaura.pa/recorrido/PARADISE%20POINT%20VR%20A.html"
...
/>
            ...
            {showPortada && (
              <div
                ...
                className="absolute inset-0 z-20 cursor-pointer flex items-center justify-center transition-all duration-300 ease-out"
              >
                <img
                  src={portadaImg}
