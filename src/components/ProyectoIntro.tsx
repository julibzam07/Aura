    ...
    <section id="proyecto" className="bg-arena-light pt-24 pb-16 md:py-32 px-6 md:px-12 relative overflow-hidden border-t border-arena-medium/40">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        <h2 className="flex flex-col items-center leading-tight mb-10 select-none">
          <span className="font-normal text-3xl sm:text-5xl md:text-6xl tracking-wide text-carbón" data-reveal="fade-up">
            Donde termina
          </span>
          <span className="font-light italic text-2xl sm:text-4xl md:text-5xl tracking-wide text-carbón/60 mt-3" data-reveal="fade-up" data-reveal-delay="150">
            y empieza el mundo.
          </span>
        </h2>

        {/* Decorative divider separator */}
        <div className="w-12 h-[2px] bg-carbón/30 mb-8" data-reveal="fade-up" data-reveal-delay="250" />

        {/* Elegant paragraph block */}
        <p className="font-sans font-light text-base sm:text-lg md:text-xl text-carbón-light/80 leading-relaxed max-w-2xl" data-reveal="fade-up" data-reveal-duration="600" data-reveal-delay="300">
        ...
        <p className="font-sans font-light italic text-xs sm:text-sm text-carbón-light/60 leading-relaxed max-w-xl mt-6 tracking-wide" data-reveal="fade-up" data-reveal-duration="600" data-reveal-delay="400">
